defmodule Genetix.Problem do
  ...
  Genetic problem behaviour definition with the problem-specific functions that a problem must to provide:
    ...
    - `statistics`:           Map name-function with statistic functions to apply. By default it calculates the minimum, maximum and the mean of the population (based on it fitness score).
